 ...
 */
static int
hwloc_solaris_x86_save_cpubind(hwloc_topology_t topology __hwloc_attribute_unused, hwloc_bitmap_t hwloc_set, int flags __hwloc_attribute_unused)
{
  processorid_t old;
...
static int
hwloc_solaris_x86_restore_cpubind(hwloc_topology_t topology __hwloc_attribute_unused, hwloc_const_bitmap_t hwloc_set, int flags __hwloc_attribute_unused)
{
			...
			struct hwloc_topology_support *support __hwloc_attribute_unused)
{
  ...
  hooks->x86_save_cpubind = hwloc_solaris_x86_save_cpubind;
  hooks->x86_restore_cpubind = hwloc_solaris_x86_restore_cpubind;
#ifdef HAVE_LIBLGRP
