...
#define HWLOC_SLEVEL_TO_DEPTH(x) (HWLOC_TYPE_DEPTH_NUMANODE-(x))
  ...
  struct hwloc_binding_hooks {
    ...
    int (*x86_set_cpubind)(hwloc_topology_t topology, hwloc_const_cpuset_t set, int flags);
    int (*x86_get_cpubind)(hwloc_topology_t topology, hwloc_cpuset_t set, int flags);
